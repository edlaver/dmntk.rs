...
fn _0001() {
  ...
  assert_business_knowledge_model(&MODEL_EVALUATOR, &MODEL_NAMESPACE, "equity36Mo", &ctx, r#"1"#);
}

#[test]
fn _0002() {
  let ctx = context(r#"{p: 2, r: 1, n: 1, pmt: 1}"#);
  assert_business_knowledge_model(&MODEL_EVALUATOR, &MODEL_NAMESPACE, "equity36Mo", &ctx, r#"2.083333333333333333333333333333333"#);
}

#[test]
fn _0003() {
  let ctx = context(r#"{p: 1, r: 1, n: 1}"#);
  assert_business_knowledge_model(&MODEL_EVALUATOR, &MODEL_NAMESPACE, "monthlyPayment", &ctx, r#"1.083333333333333333333333333333338"#);
}

#[test]
fn _0004() {
  let ctx = context(r#"{p: 2, r: 1, n: 1}"#);
  assert_business_knowledge_model(&MODEL_EVALUATOR, &MODEL_NAMESPACE, "monthlyPayment", &ctx, r#"2.166666666666666666666666666666676"#);
}
