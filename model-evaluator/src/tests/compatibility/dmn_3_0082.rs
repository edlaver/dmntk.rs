...
#[test]
fn _0011() {
  assert_decision(&MODEL_EVALUATOR, &MODEL_NAMESPACE, "decision_bkm_002", &CTX, r#"false"#);
}

#[test]
fn _0012() {
  assert_decision(&MODEL_EVALUATOR, &MODEL_NAMESPACE, "decision_bkm_003", &CTX, r#"null(after coercion)"#);
}
...
#[test]
fn _0017() {
  assert_decision(&MODEL_EVALUATOR, &MODEL_NAMESPACE, "invoke_001", &CTX, r#"false"#);
}
