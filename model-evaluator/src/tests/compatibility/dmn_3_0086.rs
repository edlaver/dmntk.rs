...
fn _0001() {
  ...
  assert_decision_1(&MODEL_EVALUATOR, NAMESPACE, "A Decision Ctx with DT", &ctx, r#""Hello John Doe!""#);
}

#[test]
fn _0002() {
  let ctx = context(r#"{A Person: {age: 47,name: "John Doe"}}"#);
  assert_decision_1(&MODEL_EVALUATOR, NAMESPACE, "A Decision Ctx with DT", &ctx, r#""Respectfully, Hello John Doe!""#);
}
