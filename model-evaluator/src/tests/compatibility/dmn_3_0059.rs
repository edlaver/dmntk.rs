...
static_model_evaluator_examples!(DMN_3_0059);
...
fn _0014() {
  let ctx = context(r#"{}"#);
  assert_decision(&MODEL_EVALUATOR, "decision014", &ctx, r#"null(expected 1+ parameters, actual number of parameters is 0)"#);
}
