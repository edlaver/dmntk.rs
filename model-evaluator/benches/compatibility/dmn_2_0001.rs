...
fn _0001(b: &mut Bencher) {
  ...
  assert_decision(&MODEL_EVALUATOR, &MODEL_NAMESPACE, invocable_name, &ctx, r#""Hello John Doe""#);
...
fn _0002(b: &mut Bencher) {
  ...
  let invocable_name = "Greeting Message";
  assert_decision(&MODEL_EVALUATOR, &MODEL_NAMESPACE, invocable_name, &ctx, r#""Hello George Gerschwin!""#);
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable_by_name(&MODEL_NAMESPACE, invocable_name, &ctx));
}
