...
static MODEL_EVALUATOR: Lazy<Arc<ModelEvaluator>> = Lazy::new(|| build_model_evaluator(dmntk_examples::DMN_3_0036));
...
fn _0001(b: &mut Bencher) {
  ...
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable_by_name(invocable_name, &CTX1));
}
...
fn _0009(b: &mut Bencher) {
  ...
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable_by_name(invocable_name, &CTX2));
}
...
fn _0017(b: &mut Bencher) {
  ...
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable_by_name(invocable_name, &CTX3));
}
