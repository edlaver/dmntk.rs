...
fn _0001(b: &mut Bencher) {
  ...
  b.iter(|| MODEL_EVALUATOR_A.evaluate_invocable_by_name(NAMESPACE_A, invocable_name, &ctx));
}
...
fn _0002(b: &mut Bencher) {
  ...
  b.iter(|| MODEL_EVALUATOR_B1.evaluate_invocable_by_name(NAMESPACE_B1, invocable_name, &ctx));
}
...
fn _0003(b: &mut Bencher) {
  ...
  b.iter(|| MODEL_EVALUATOR_B2.evaluate_invocable_by_name(NAMESPACE_B2, invocable_name, &ctx));
}
...
fn _0004(b: &mut Bencher) {
  ...
  b.iter(|| MODEL_EVALUATOR_C.evaluate_invocable_by_name(NAMESPACE_C, invocable_name, &ctx));
}
