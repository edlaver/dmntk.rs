...
static MODEL_EVALUATOR: Lazy<Arc<ModelEvaluator>> = Lazy::new(|| build_model_evaluator(dmntk_examples::DMN_2_0008));
...
fn _0002(b: &mut Bencher) {
  ...
  let invocable_name = "payment";
  assert_decision(&MODEL_EVALUATOR, invocable_name, &ctx, r#"562.7073593732659271562143285576407"#);
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable(invocable_name, &ctx));
}
...
fn _0003(b: &mut Bencher) {
  ...
  let invocable_name = "payment";
  assert_decision(&MODEL_EVALUATOR, invocable_name, &ctx, r#"2861.03377700390163671626277960579"#);
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable(invocable_name, &ctx));
}
