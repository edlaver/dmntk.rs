...
static MODEL_EVALUATOR: Lazy<Arc<ModelEvaluator>> = Lazy::new(|| build_model_evaluator(dmntk_examples::DMN_2_0105));
...
fn _0007(b: &mut Bencher) {
  ...
  assert_decision(&MODEL_EVALUATOR, invocable_name, &ctx, r#"32"#);
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable(invocable_name, &ctx));
}
...
fn _0011(b: &mut Bencher) {
  ...
  assert_decision(&MODEL_EVALUATOR, invocable_name, &ctx, r#"-225"#);
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable(invocable_name, &ctx));
}
...
fn _0017(b: &mut Bencher) {
  ...
  assert_decision(&MODEL_EVALUATOR, invocable_name, &ctx, r#"100000"#);
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable(invocable_name, &ctx));
}
...
fn _0018(b: &mut Bencher) {
  ...
  assert_decision(&MODEL_EVALUATOR, invocable_name, &ctx, r#"0.00001"#);
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable(invocable_name, &ctx));
}
...
fn _0019(b: &mut Bencher) {
  ...
  assert_decision(&MODEL_EVALUATOR, invocable_name, &ctx, r#"16807"#);
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable(invocable_name, &ctx));
}
...
fn _0020(b: &mut Bencher) {
  ...
  assert_decision(&MODEL_EVALUATOR, invocable_name, &ctx, r#"37"#);
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable(invocable_name, &ctx));
}
...
fn _0021(b: &mut Bencher) {
  ...
  assert_decision(&MODEL_EVALUATOR, invocable_name, &ctx, r#"40"#);
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable(invocable_name, &ctx));
}
...
fn _0022(b: &mut Bencher) {
  ...
  assert_decision(&MODEL_EVALUATOR, invocable_name, &ctx, r#"261"#);
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable(invocable_name, &ctx));
}
...
fn _0032(b: &mut Bencher) {
  ...
  assert_decision(&MODEL_EVALUATOR, invocable_name, &ctx, r#"7.5"#);
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable(invocable_name, &ctx));
}
...
fn _0033(b: &mut Bencher) {
  ...
  assert_decision(&MODEL_EVALUATOR, invocable_name, &ctx, r#"1200"#);
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable(invocable_name, &ctx));
}
