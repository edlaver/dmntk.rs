...
fn _0003(b: &mut Bencher) {
  ...
  assert_decision(&MODEL_EVALUATOR, &MODEL_NAMESPACE, invocable_name, &ctx, r#"[["w", "x"], ["y"], ["z"], ["t"]]"#);
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable_by_name(&MODEL_NAMESPACE, invocable_name, &ctx));
}
...
fn _0004(b: &mut Bencher) {
  ...
  assert_decision(&MODEL_EVALUATOR, &MODEL_NAMESPACE, invocable_name, &ctx, r#"[["w", "x"], ["y"], ["z"], ["a", "b", "c"]]"#);
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable_by_name(&MODEL_NAMESPACE, invocable_name, &ctx));
}
