...
curl -s -d '{"namespace":"io.dmntk","model":"compliance-level-2-test-0001","invocable":"Greeting Message"}' -H "Content-Type: application/json" -X POST http://0.0.0.0:22022/tck/evaluate
