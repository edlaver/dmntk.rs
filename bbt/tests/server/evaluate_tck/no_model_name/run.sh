...
curl -s -d '{"namespace":"io.dmntk","invocable":"Greeting Message","input":[{"name":"Full Name","value":{"simple":{"type":"xsd:string","text":"John Doe","isNil":false}}}]}' -H "Content-Type: application/json" -X POST http://0.0.0.0:22022/tck/evaluate
