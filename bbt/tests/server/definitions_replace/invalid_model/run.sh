...
# prepare JSON data file containing a valid model to be added to workspace
echo -n '{"content":"' > data.json
base64 --wrap=0 2_0001_valid.dmn >> data.json
echo -n '"}' >> data.json
...
# prepare JSON data file containing an invalid model to be replaced in workspace
echo -n '{"content":"' > data.json
