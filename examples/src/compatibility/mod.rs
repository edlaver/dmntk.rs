...
pub const DMN_3_0089_MODEL_A: &str = include_str!("level_3/3_0089_model_A.dmn");
pub const DMN_3_0089_MODEL_B1: &str = include_str!("level_3/3_0089_model_B1.dmn");
pub const DMN_3_0089_MODEL_B2: &str = include_str!("level_3/3_0089_model_B2.dmn");
pub const DMN_3_0089_MODEL_C: &str = include_str!("level_3/3_0089_model_C.dmn");
...
pub const DMN_3_1130: &str = include_str!("level_3/3_1130.dmn");
