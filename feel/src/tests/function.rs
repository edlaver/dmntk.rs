...
fn test_function_body_context() {
  ...
  let fun_body_a = FunctionBody::Context(Arc::new(Box::new(|_: &Scope| value_number!(10))));
...
fn test_function_body_literal_expression() {
  ...
  let fun_body_a = FunctionBody::LiteralExpression(Arc::new(Box::new(|_: &Scope| value_number!(20))));
  assert_eq!(fun_body, fun_body_a);
...
fn test_function_body_decision_table() {
  ...
  let fun_body_a = FunctionBody::DecisionTable(Arc::new(Box::new(|_: &Scope| value_number!(30))));
  assert_eq!(fun_body, fun_body_a);
  assert_eq!(fun_body, fun_body.clone());
}
...
fn test_function_body_decision_service() {
  ...
  let fun_body_a = FunctionBody::DecisionService(Arc::new(Box::new(|_: &Scope| value_number!(40))));
  assert_eq!(fun_body, fun_body_a);
  assert_eq!(fun_body, fun_body.clone());
}
...
fn test_function_body_external() {
  ...
  let fun_body_a = FunctionBody::External(Arc::new(Box::new(|_: &Scope| value_number!(50))));
  assert_eq!(fun_body, fun_body_a);
  assert_eq!(fun_body, fun_body.clone());
}
